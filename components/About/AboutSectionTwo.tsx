        ...
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-full">
            <div className="wow fadeInUp w-full" data-wow-delay=".2s">
              <div className="mb-9 flex flex-col items-center justify-center lg:flex-row lg:items-center">
                <div className="  lg:w-5/6 lg:pr-4">
                  ...
                  <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    ...
                    <br /> 1. Kommunikativ yanaşma: Dili gündəlik həyatda
                    istifadə etməyə imkan yaradan, praktik danışıq və dinləmə
                    bacarıqlarını inkişaf etdirən dərslərdir.
                    <br />
                    2. Səviyyələrə uyğun tədris: Dil biliklərinə uyğun olaraq
                    A1-dən C2-yə qədər səviyyələrdə dərslər keçir və hər
                    səviyyədə dil bacarıqları artırılır.
                    <br /> 3. İnteraktiv dərslər: Rollu oyunlar, qrup
                    tapşırıqları və dialoqlar tələbələrin danışıq qabiliyyətini
                    inkişaf etdirir.
                ...
                <div className="relative h-64 w-64 flex-shrink-0 lg:ml-4">
                  <Image
                    src="/images/about/almanca.png"
                    alt="İngilis Dili"
                    fill
              ...
              <div className="mb-9 flex flex-col lg:flex-row lg:items-center">
                <div className="relative h-64 w-64 flex-shrink-0 lg:mr-4">
                  <Image
                    src="/images/about/almanca.png" // Alman Dili resmi
                    alt="Alman Dili"
                    fill
                    className="rounded object-cover"
                  />
                ...
                <div className="lg:w-5/6">
                  ...
                  <p className="sm:text-md text-base font-medium leading-relaxed text-body-color sm:leading-relaxed">
                    ...
                    situasiyalar üzərindən öyrənir. Dialoqlar və söhbətlər
                    dərsin əsasını təşkil edir. <br />
              ...
              <div className="mb-9 flex flex-col lg:flex-row lg:items-center">
                <div className="lg:w-5/6">
                  ...
                  <p className="sm:text-md text-base font-medium leading-relaxed text-body-color sm:leading-relaxed">
                    ...
                    bacarıqlarını inkişaf etdirməyə yönəldilib. <br /> 1.
                    Danışıq mərkəzli yanaşma: Dərslərdə əsas məqsəd tələbələrin
                    fransız dilində sərbəst danışmasını təmin etməkdir.
                    Ünsiyyətə, dialoqlara və real həyatda istifadə olunan
                    ifadələrə diqqət yetirilir. <br /> 2. Qrammatika kontekstdə
                    öyrədilir: Qrammatik qaydalar və struktur dərslərin əsas
                    hissəsi deyil, praktiki danışıq əsnasında təbii şəkildə
                    öyrədilir. <br /> 3. Səviyyə əsaslı dərslər: Danışıq əsaslı
                    dərslər A1-dən C2-yə qədər hər səviyyəyə uyğunlaşdırılır,
                    tələbələrin dil bilikləri inkişaf etdikcə danışıq mövzuları
                    da çətinləşir. <br /> 4. İnteraktiv metodlar: Rollu oyunlar,
                    müzakirələr və qrup işləri dərslərin əsasını təşkil edir, bu
                    da tələbələrə danışıq təcrübəsi qazandırır. <br /> 5.
                    Dinləmə və tələffüz inkişafı: Fransız dilinin təbii
                    axıcılığına və düzgün tələffüzə xüsusi diqqət yetirilir,
                    bunun üçün səsli materiallar və danışıq təlimləri istifadə
                    olunur. <br /> Danışıq əsaslı fransız dili dərsləri, dili
                    effektiv öyrənmək və real həyatda ünsiyyət qurmaq istəyənlər
                    üçün ən uyğun tədris metodudur.
                  </p>
                </div>
                <div className="relative h-64 w-64 flex-shrink-0 lg:ml-4">
                  <Image
              ...
              <div className="mb-1 flex flex-col lg:flex-row lg:items-center">
                <div className="relative mr-3 h-64 w-64 flex-shrink-0 lg:ml-4">
                  <Image
                    src="/images/about/almanca.png"
                    alt="Rus Dili"
                    fill
                ...
                <div className="lg:ml-2 lg:w-5/6">
                  <h3 className="mb-4 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                    Rus Dili
                  </h3>
                  <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                    ...
                    bacarıqlarına xüsusi önəm verilir, tələbələr gündəlik
                    həyatda rahat ünsiyyət qurmağı öyrənirlər. <br /> 2.
                    Səviyyələr üzrə tədris: Dərslər A1-dən C2-yə qədər müxtəlif
                    səviyyələr üzrə təşkil olunur və hər səviyyədə şagirdlərin
                    bacarıqları mərhələli şəkildə inkişaf etdirilir.
                    ...
                    proqramlar təklif edir. <br /> Red Kalinka metodu ilə
                    dərslər, rus dilini öyrənmək üçün ideal seçimdir, çünki
                    praktiki yanaşma və geniş resurslar sayəsində tələbələr dili
                    sürətli və effektiv şəkildə mənimsəyirlər.
                  </p>
                </div>
              </div>
            </div>
